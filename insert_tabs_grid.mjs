...
const targetStr = `          <div className="flex-1 overflow-auto bg-gray-100 relative custom-scrollbar px-4 pb-4 pt-0">
            <div className="inline-block min-w-full align-middle border-x border-b border-gray-300 bg-white shadow-sm">
              <table className="min-w-full divide-y divide-gray-300 table-fixed">`;

const replacementStr = `          <div className="flex-1 overflow-auto bg-gray-100 relative custom-scrollbar px-4 pb-4 pt-0">
            <div className="inline-block min-w-full align-middle border-x border-b border-gray-300 bg-white shadow-sm">
              {activeTab === 'schedule' && (
              <table className="min-w-full divide-y divide-gray-300 table-fixed">`;
...
const endTargetStr = `              </tbody>
            </table>
            {filteredCustomers.length === 0 && (`;

const endReplacementStr = `              </tbody>
            </table>
              )}
