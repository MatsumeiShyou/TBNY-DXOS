...
3. **スケジュール調整カレンダー自動展開機能**
   ...
   - 顧客マスタに登録された回収頻度（第1・第4・毎週等）に基づいて、指定月のスケジュールを俯瞰できます。
   - **例外の視覚化と手動調整**: 年に数回のイレギュラー（お客様都合の休業、突然のスポット依頼、前後の日への手動ズラし）をカレンダー上で俯瞰し、ドラッグ＆ドロップで例外対応を一括管理できます。
   - 「配車盤へ」ボタンを押すことで、指定した日付の配車盤（メイン画面）へ素早くジャンプできます。
4. **全体休業日設定**
