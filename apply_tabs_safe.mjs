...
const targetTableStart = `<table className="min-w-full divide-y divide-gray-300 table-fixed">`;
const replacementTableStart = `{activeTab === 'schedule' && (
...
const replacementTableEnd = `              </tbody>
            ...
            {filteredCustomers.length === 0 && (`;
code = code.replace(targetTableEnd, replacementTableEnd);
