...
export default function BoardCanvas() {
    ...
    return (
        <div
            className="tw-h-full tw-flex tw-flex-col tw-bg-slate-50 tw-relative tw-overflow-hidden tw-select-none tw-outline-none"
            tabIndex={0}
        ...
        >
            ...
            <div className="tw-flex tw-flex-1 tw-overflow-hidden tw-relative">
                <div className="tw-flex-1 tw-overflow-auto tw-relative tw-h-full tw-bg-[#f8fafc]">
                    <DriverHeader
                        drivers={drivers}
                        ...
                        stickyTop="top-0"
                    />
                    <div className="tw-relative" ref={gridContainerRef}>
                        <TimeGrid
                            drivers={drivers}
                            jobs={validatedJobs}
                            splits={splits}
            ...
            <div className="tw-h-7 tw-px-4 tw-bg-slate-100 tw-border-t tw-border-slate-200 tw-text-[10px] tw-font-bold tw-flex tw-items-center tw-gap-4 tw-text-slate-500">
                ...
                <span className="tw-ml-auto">
                    {!validation.isValid ? (
                        <span className="tw-flex tw-items-center tw-gap-1 tw-text-amber-600">
                            <AlertTriangle size={12} />
                            {validation.summary}
                        </span>
                    ) : (
                        <span className="tw-text-emerald-600 tw-italic">READY: {validation.summary}</span>
                    )}
                </span>
            </div>
