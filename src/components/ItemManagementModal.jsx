...
export default function ItemManagementModal({ items = [], onSave, onDelete, onClose }) {
                  ...
                  <tr key={item.id} className="border-b hover:bg-gray-50 transition-colors group">
                    {editingId === item.id ? (
                      ...
                      <>
                        ...
                        <td className="p-3 text-gray-600">{item.estimatedDuration > 0 ? `${item.estimatedDuration}分` : <span className="text-gray-400">-</span>}</td>
