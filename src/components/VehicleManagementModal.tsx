...
interface VehicleManagementModalProps {
  ...
  onSave: (vehicle: MasterVehicle, isEdit: boolean) => void;
  onDelete: (id: string) => void;
  onClose: () => void;
}

export default function VehicleManagementModal({ vehicles, onSave, onDelete, onClose }: VehicleManagementModalProps) {
  ...
  const startEdit = (vehicle: MasterVehicle) => {
