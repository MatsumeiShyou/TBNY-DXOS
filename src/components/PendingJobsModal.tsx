              ...
              <div className="flex justify-between items-start">
                <div className="flex items-center gap-2 overflow-hidden">
                  ...
                  <div className="flex items-center overflow-hidden">
                    {job.isDeleted && <span className="flex-shrink-0 bg-red-100 text-red-700 border border-red-200 text-[10px] px-1 rounded-sm mr-2 font-bold leading-tight">削除済</span>}
                    {job.isSuspended && !job.isDeleted && <span className="flex-shrink-0 bg-yellow-100 text-yellow-700 border border-yellow-200 text-[10px] px-1 rounded-sm mr-2 font-bold leading-tight">停止中</span>}
