                  ...
                  <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-200">
                    ...
                    <div className="grid grid-cols-2 gap-x-5 gap-y-2.5">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1">
                          <input type="text" name="kana" value={formData.kana} onChange={handleChange} onBlur={handleKanaBlur} onKeyDown={e => { if(e.key === 'Enter' && !e.nativeEvent.isComposing){ e.preventDefault(); e.currentTarget.blur(); } }} className={`w-full border rounded px-2 py-1.5 text-sm ${validationErrors.kana ? 'border-red-500 bg-red-50' : ''}`} placeholder="カタカナで入力" />
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <SearchableMultiSelect
                              options={(masterItems || []).filter(i => i.is_active !== false || (formData.items || []).includes(i.id))}
